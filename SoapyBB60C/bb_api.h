...
#define BB_STREAM_IF             0x1 // Deprecated
...
BB_API bbStatus bbFetchRealTimeFrame(int device, float *minSweep, float *maxSweep, float *frame, float *alphaFrame);
...
BB_API bbStatus bbGetIQUnpacked(int device, void *iqData, int iqCount,
